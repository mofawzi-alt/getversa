...
const QUESTION_SIDE_ALIASES: Record<string, Partial<Record<PollImageSide, string>>> = {
  ...
  // Fix duplicate pairs
  'swvl or microbus': { A: 'swvl.jpg', B: 'microbus.jpg' },
  'alarm or body clock': { A: 'alarm-clock.jpg', B: 'body-clock.jpg' },
  'phone alarm or sunrise wake up': { A: 'alarm-clock.jpg', B: 'sunrise.jpg' },
  'hire a maid or do it yourself': { A: 'maid-service.jpg', B: 'diy-cleaning.jpg' },
  'hire maid or do it yourself': { A: 'maid-service.jpg', B: 'diy-cleaning.jpg' },
  'hijab fashion or abaya style': { A: 'hijab-fashion.jpg', B: 'abaya.jpg' },
