...
export default function SwipeOverlay({ onDismiss }: SwipeOverlayProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[100] flex flex-col items-center safe-area-top safe-area-bottom"
      style={{ backgroundColor: '#111111' }}
    >
      {/* Top logo */}
      <div className="pt-14 pb-4">
        <VersaLogo size="md" className="brightness-0 invert opacity-60" />
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 px-8 max-w-sm text-center -mt-10">
        ...
        <div className="relative w-48 h-72 rounded-3xl border-2 border-white/15 flex items-center justify-center overflow-hidden"
          style={{ backgroundColor: 'rgba(255,255,255,0.03)' }}
        >
          <div className="absolute inset-3 rounded-2xl border border-white/8" style={{ backgroundColor: 'rgba(255,255,255,0.02)' }} />
