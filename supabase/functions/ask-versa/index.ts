...
const CATEGORY_MAP: Record<string, string[]> = {
  ...
  "food": ["FMCG & Food", "Food Delivery & Dining"],
  "restaurant": ["Food Delivery & Dining", "FMCG & Food"],
  "restaurants": ["Food Delivery & Dining", "FMCG & Food"],
  "dining": ["Food Delivery & Dining"],
  "cafe": ["Food Delivery & Dining", "FMCG & Food"],
  "coffee": ["Food Delivery & Dining", "FMCG & Food"],
  "delivery": ["Food Delivery & Dining"],
  "lifestyle": ["Lifestyle & Society"],
  "personality": ["Lifestyle & Society"],
  "relationships": ["Lifestyle & Society"],
  "fashion": ["Beauty & Personal Care", "Lifestyle & Society"],
  "clothing": ["Beauty & Personal Care", "Lifestyle & Society"],
  "telecom": ["Telco & Tech"],
  "tech": ["Telco & Tech"],
  "technology": ["Telco & Tech"],
  "phones": ["Telco & Tech"],
  "mobile": ["Telco & Tech"],
  "cars": ["Lifestyle & Society"],
  "travel": ["Lifestyle & Society"],
  "education": ["Lifestyle & Society"],
  "university": ["Lifestyle & Society"],
...
- "offscope" = harmful, code, math homework, gibberish.`,
    ...
    const CONCEPT_EXPANSION: Record<string, { keywords: string[]; categories: string[] }> = {
      students: { keywords: ["student", "school", "university", "college", "uni", "class", "campus", "studying", "education"], categories: ["Education"] },
      student: { keywords: ["student", "school", "university", "college", "uni", "class", "campus", "studying", "education"], categories: ["Education"] },
      learning: { keywords: ["learn", "study", "class", "school", "university", "online class", "hybrid", "in-person", "remote", "education"], categories: ["Education"] },
      online: { keywords: ["online", "remote", "virtual", "hybrid", "digital", "zoom"], categories: [] },
      school: { keywords: ["school", "student", "class", "university", "education"], categories: ["Education"] },
      university: { keywords: ["university", "uni", "college", "campus", "student", "auc", "guc"], categories: ["Education"] },
      college: { keywords: ["college", "university", "uni", "campus", "student"], categories: ["Education"] },
      work: { keywords: ["work", "job", "career", "office", "remote", "hybrid", "workplace", "employer"], categories: ["Money"] },
      job: { keywords: ["job", "work", "career", "salary", "employer", "office"], categories: ["Money"] },
      youth: { keywords: ["youth", "young", "gen z", "teen", "teenager", "student"], categories: ["Education"] },
      teens: { keywords: ["teen", "teenager", "youth", "young", "gen z", "student"], categories: ["Education"] },
      women: { keywords: ["women", "woman", "girl", "female", "lady"], categories: [] },
      men: { keywords: ["men", "man", "guy", "male", "boy"], categories: [] },
      parents: { keywords: ["parent", "mom", "dad", "father", "mother", "family", "kids"], categories: ["Relationships"] },
      marriage: { keywords: ["marriage", "wedding", "married", "spouse", "husband", "wife", "engagement"], categories: ["Relationships"] },
      dating: { keywords: ["dating", "date", "relationship", "partner", "boyfriend", "girlfriend", "love"], categories: ["Relationships"] },
      relationship: { keywords: ["relationship", "partner", "dating", "love", "marriage"], categories: ["Relationships"] },
      fitness: { keywords: ["fitness", "gym", "workout", "exercise", "training", "sport"], categories: ["Lifestyle"] },
      health: { keywords: ["health", "wellness", "fitness", "diet", "mental", "doctor"], categories: ["Lifestyle"] },
      money: { keywords: ["money", "salary", "savings", "income", "rent", "afford", "expensive", "cheap", "budget"], categories: ["Money"] },
      saving: { keywords: ["save", "saving", "savings", "money", "budget", "afford"], categories: ["Money"] },
      spending: { keywords: ["spend", "spending", "money", "afford", "expensive", "budget"], categories: ["Money"] },
      politics: { keywords: ["politics", "government", "vote", "election", "policy"], categories: ["Lifestyle"] },
      news: { keywords: ["news", "media", "current", "events"], categories: ["Entertainment"] },
      religion: { keywords: ["religion", "faith", "islam", "muslim", "christian", "pray"], categories: ["Lifestyle"] },
      music: { keywords: ["music", "song", "artist", "playlist", "spotify", "anghami"], categories: ["Entertainment"] },
      movie: { keywords: ["movie", "film", "cinema", "netflix", "watch", "series"], categories: ["Entertainment"] },
      film: { keywords: ["movie", "film", "cinema", "netflix", "watch", "series"], categories: ["Entertainment"] },
      tv: { keywords: ["tv", "series", "show", "netflix", "shahid", "watch"], categories: ["Entertainment"] },
      shopping: { keywords: ["shop", "shopping", "buy", "store", "mall", "online shopping"], categories: ["Lifestyle"] },
      housing: { keywords: ["housing", "rent", "apartment", "flat", "home", "compound", "buy"], categories: ["Lifestyle"] },
      rent: { keywords: ["rent", "rental", "apartment", "flat", "housing"], categories: ["Lifestyle"] },
      transport: { keywords: ["transport", "car", "uber", "careem", "bus", "metro", "commute"], categories: ["Lifestyle"] },
      commute: { keywords: ["commute", "transport", "traffic", "uber", "metro", "drive"], categories: ["Lifestyle"] },
      traffic: { keywords: ["traffic", "commute", "transport", "drive", "uber"], categories: ["Lifestyle"] },
